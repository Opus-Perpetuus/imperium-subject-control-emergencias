...
WORKDIR /app
LABEL org.opencontainers.image.source="https://github.com/Opus-Perpetuus/imperium-subject-control-emergencias"
LABEL org.opencontainers.image.url="https://github.com/Opus-Perpetuus/imperium-subject-control-emergencias"
...
COPY src ./src
ENV PORT=3000 \
    SUBJECT_TECHNICAL_ID=subject-control-emergencias \
    KIRLET_TECHNICAL_ID=subject-control-emergencias \
    DATA_DIR=/data \
    SUBJECT_AUTH=on \
    KIRLET_AUTH=on
