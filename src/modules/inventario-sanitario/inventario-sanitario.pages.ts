        ...
        props: {
          ...
          table: {
            columns: [
              ...
              { key: "entradas", label: "entradas", sortable: true, priority: 3 },
              { key: "salidas", label: "salidas", sortable: true, priority: 3 },
              { key: "fecha_salida", label: "fecha salida", sortable: true, priority: 3 },
