...
export const asociaciones_module = define_module({
  ...
  menu: [
    ...
    },
    {
      ...
      label: "Categorías de inventario sanitario",
      order: 11,
      pageId: "control-emergencias.categoria-inventario-sanitario",
    ...
    },
    {
      ...
      label: "Categorías de despensa solidaria",
      order: 12,
      pageId: "control-emergencias.categoria-despensa-solidaria",
